    ...
    >
      ...
      <div
        style={{
          ...
          background: isBot
            ? PALETTE.card
            : "linear-gradient(135deg, #DC143C, #C41230)",
      ...
      {tabs.map((t) => (
        <button
          ...
          style={{
            ...
            border: "none",
            borderRadius: 8,
            background: active === t.id ? "linear-gradient(135deg, #DC143C, #C41230)" : "transparent",
        ...
        {tab === "play" && (
          ...
          >
            ...
            <textarea
              ...
              placeholder="Share your CNY wishes... (恭喜發財!)"
              rows={2}
              style={{
                width: "100%",
                padding: "10px 14px",
